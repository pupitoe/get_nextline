...
/*   Updated: 2023/11/04 12:44:53 by tlassere         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line_bonus.h"

static void	ft_move_buffer(char *buffer, size_t moving)
{
	size_t	start;
	...
	while (start < BUFFER_SIZE && buffer[start] != '\n')
		start++;
	start++;
	while (moving + start < BUFFER_SIZE)
	{
...
static char	*ft_cat(char *s1, char *s2, unsigned int max_s2)
{
	size_t	max_s1;
	size_t	i;
	char	*new_string;
